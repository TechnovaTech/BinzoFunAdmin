...
export function DiceGame() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 sm:p-4 border-b border-slate-700 gap-2 sm:gap-0">
        <Button asChild variant="ghost" size="sm" className="text-slate-300 hover:text-white w-full sm:w-auto">
          <Link href="/games">
        ...
        <Badge variant="outline" className="px-2 sm:px-3 py-1 border-slate-600 text-slate-300 text-xs sm:text-sm">
          <Dice6 className="h-3 w-3 sm:h-4 sm:w-4 mr-1" />
          Provably Fair
        </Badge>
      </div>
      ...
      <div className="flex justify-center min-h-[calc(100vh-80px)]">
        <div className="flex flex-col lg:flex-row max-w-7xl w-full">
          <div className="w-full lg:w-80 bg-slate-800 border-b lg:border-r lg:border-b-0 border-slate-700 p-4 sm:p-6 space-y-4 sm:space-y-6">
            <div className="flex bg-slate-700 rounded-lg p-1">
              <Button
                variant={!isAutoMode ? "default" : "ghost"}
                size="sm"
                onClick={() => setIsAutoMode(false)}
                className="flex-1 bg-slate-600 hover:bg-slate-500 text-white text-xs sm:text-sm"
              >
                Manual
              </Button>
              <Button
                ...
                className="flex-1 text-slate-300 hover:bg-slate-600 text-xs sm:text-sm"
              >
                Auto
              </Button>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  min="0"
                  step="0.01"
                  className="bg-slate-700 border-slate-600 text-white text-sm sm:text-lg font-mono pr-16 sm:pr-20"
                  placeholder="10.00"
                ...
                <div className="absolute right-2 top-1/2 transform -translate-y-1/2 flex space-x-1">
                  <Button
                    ...
                    disabled={isRolling || isAutoMode}
                    className="h-5 w-5 sm:h-6 sm:w-6 p-0 text-orange-400 hover:bg-slate-600 text-xs"
                  >
                    ½
                  </Button>
                  <Button
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  readOnly
                  className="bg-slate-700 border-slate-600 text-white text-sm sm:text-lg font-mono pr-8"
                  placeholder="0.00"
                />
            ...
            <Button
              ...
              className="w-full h-10 sm:h-12 bg-green-500 hover:bg-green-600 text-white font-bold text-sm sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isRolling ? (
                <>
            ...
            <div className="w-full max-w-3xl space-y-4 sm:space-y-8">
                ...
                <div className="text-center">
                  <div className="flex flex-wrap justify-center gap-1 sm:gap-2 mb-4">
                    {gameHistory.slice(0, 6).map((game, index) => (
                      <div
                        key={game.timestamp}
                        className={`px-2 sm:px-4 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-bold font-mono ${
              ...
              <div className="relative px-2 sm:px-4">
                ...
                <div className="h-6 sm:h-8 bg-slate-700 rounded-full relative overflow-hidden">
                  ...
                  />
                  <div
                    className="absolute top-1/2 transform -translate-y-1/2 -translate-x-1/2 w-4 h-4 sm:w-6 sm:h-6 bg-blue-500 rounded border-2 border-white shadow-lg cursor-pointer"
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6 max-w-2xl mx-auto">
                <div className="text-center">
                  ...
                  <div className="text-sm sm:text-xl font-bold text-white flex items-center justify-center">
                    {multiplier.toFixed(4)} <span className="ml-1 text-sm sm:text-lg">×</span>
                  </div>
                </div>
                <div className="text-center">
                  <div className="text-xs sm:text-sm text-slate-400 mb-1">Roll {isOver ? "Over" : "Under"}</div>
                  <div className="text-sm sm:text-xl font-bold text-white flex items-center justify-center">
                    {rollOver.toFixed(2)} <span className="ml-1 text-xs sm:text-sm">🔄</span>
                  </div>
                </div>
                <div className="text-center">
                  <div className="text-xs sm:text-sm text-slate-400 mb-1">Win Chance</div>
                  <div className="text-sm sm:text-xl font-bold text-white flex items-center justify-center">
                    {winChance.toFixed(4)} <span className="ml-1 text-sm sm:text-lg">%</span>
                  </div>
                </div>
              </div>
            </div>
