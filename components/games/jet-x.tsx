...
export function JetXGame() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white">
      {/* Header */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 sm:p-6 border-b border-blue-800/30 bg-black/20 backdrop-blur-sm gap-3 sm:gap-0">
        <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 w-full sm:w-auto">
          <Button asChild variant="ghost" size="sm" className="text-white hover:bg-blue-800/30 w-full sm:w-auto">
            <Link href="/games">
        ...
        <div className="flex items-center space-x-2 w-full sm:w-auto justify-end">
          <Badge variant="outline" className="px-2 sm:px-3 py-1 border-cyan-400/50 text-cyan-300 text-xs sm:text-sm">
            ...
            <span className="hidden sm:inline">Crash Game</span>
      ...
      <div className="max-w-7xl mx-auto p-3 sm:p-6">
        {/* Recent Crashes */}
        <Card className="p-3 sm:p-6 bg-gradient-to-br from-slate-800/50 to-blue-900/50 border-cyan-500/30 backdrop-blur-sm mb-4 sm:mb-6">
          ...
          <div className="flex flex-wrap gap-1 sm:gap-2">
            {gameHistory.map((crash, index) => (
              <div
                key={index}
                className={`px-2 sm:px-4 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-bold transition-all hover:scale-105 ${
                  crash < 1.5
        ...
        <Card className="p-0 bg-gradient-to-br from-slate-800/50 to-blue-900/50 border-cyan-500/30 mb-4 sm:mb-6 overflow-hidden backdrop-blur-sm shadow-2xl shadow-cyan-500/20">
          <div className="relative">
            ...
            <div className="absolute top-3 sm:top-6 left-3 sm:left-6">
              {crashed ? (
                <div className="text-center">
                  <div className="text-2xl sm:text-4xl font-black text-red-500 animate-pulse mb-1 sm:mb-2">
                    CRASHED
                  </div>
                  <div className="text-lg sm:text-2xl text-red-400">
                ...
                <div className="text-center">
                  ...
                  {isPlaying && (
                    <div className="text-cyan-300 text-sm sm:text-lg animate-bounce">
              ...
              <div className="absolute top-3 sm:top-6 right-3 sm:right-6">
                <div className="bg-black/50 backdrop-blur-sm rounded-lg px-2 sm:px-4 py-1 sm:py-2">
                  <div className="text-cyan-400 text-xs sm:text-sm font-bold">
                    🚀 <span className="hidden sm:inline">Speed:</span> {speed} km/h
                  </div>
                </div>
              </div>
            )}
            ...
            {cashedOut && (
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <div className="bg-emerald-500 text-white px-4 sm:px-8 py-2 sm:py-4 rounded-xl text-lg sm:text-2xl font-bold animate-bounce shadow-2xl text-center">
            ...
            {!isPlaying && !crashed && !showDemoCrash && (
              <div className="absolute bottom-3 sm:bottom-6 left-1/2 transform -translate-x-1/2">
                <div className="text-cyan-400 text-sm sm:text-lg animate-pulse">
                  🎮 Ready for flight...
                </div>
              </div>
            )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
          <Card className="p-4 sm:p-6 bg-gradient-to-br from-slate-800/50 to-blue-900/50 border-cyan-500/30 backdrop-blur-sm">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="grid grid-cols-4 gap-1 sm:gap-2">
                <Button onClick={() => setBet(10)} disabled={isPlaying} variant="outline" size="sm" className="border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-white text-xs sm:text-sm">$10</Button>
                <Button onClick={() => setBet(50)} disabled={isPlaying} variant="outline" size="sm" className="border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-white text-xs sm:text-sm">$50</Button>
                <Button onClick={() => setBet((prev) => Math.max(1, prev / 2))} disabled={isPlaying} variant="outline" size="sm" className="border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-white text-xs sm:text-sm">1/2</Button>
                <Button onClick={() => setBet((prev) => prev * 2)} disabled={isPlaying} variant="outline" size="sm" className="border-gray-600 text-gray-300 hover:bg-gray-800 hover:text-white text-xs sm:text-sm">2x</Button>
              </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              {!isPlaying ? (
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-emerald-500 to-blue-500 hover:from-emerald-600 hover:to-blue-600 text-white font-bold py-3 sm:py-4 text-sm sm:text-lg rounded-lg shadow-lg transform hover:scale-105 transition-all"
                >
                  🚀 Start Flight (${bet})
                </Button>
              ) : (
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-bold py-3 sm:py-4 text-sm sm:text-lg rounded-lg shadow-lg animate-pulse"
                >
